...
const ClientsPage = () => {
  ...
  // 🔍 Filtre mis à jour : Recherche par numéro de téléphone OU par nom (insensible à la casse)
  ...
  return (
    <div className="space-y-4">
      ...
      <input 
        ...
        placeholder="Rechercher par prénom ou numéro..."
            ...
            filtered?.map((client) => (
              <div key={client.id} className="flex items-center justify-between px-6 py-4 hover:bg-gray-800 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    {/* 👤 Affichage mis à jour : Combine le prénom s'il existe avec le numéro */}
